...
def svg_pos_parser_apply(file_name: str) -> Tuple[Dict[str, Any], Dict[str, Any]]:
...
def layouter(bpmn_graph, parameters=None):
    """
    ...
    nodes_p, edges_p = svg_pos_parser_apply(filename_svg.name)
