from utils.powl.BinaryRelation import BinaryRelation
from utils.powl.constants import STRICT_PARTIAL_ORDER_LABEL
...
class POWL(ProcessTree, ABC):
    ...
    def model_description() -> str:
        descr = """A partially ordered workflow language (POWL) is a partially ordered graph representation of a process, extended with control-flow operators for model_generation choice and loop structures. There are four types of POWL models:
